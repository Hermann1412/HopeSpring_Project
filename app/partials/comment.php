	...
	<div id="post" style="background-color: #eee;">
		...
		<div style="width: 100%;">
			<div style="font-weight: bold;color: rgb(152, 52, 240);width: 100%;">
				<?php 
		...
		?>
		<a href="like.php?type=post&id=<?php echo $COMMENT['postid'] ?>&csrf_token=<?php echo urlencode(csrf_token()); ?>">Like<?php echo $likes ?></a> . 
		...
		<span style="color: #999;float:right">
			...
			<?php 
				...
				if(isset($_SESSION['mybook_userid'])){
					...
					$result = $DB->read_prepared($sql, "si", ["post", (int)$COMMENT['postid']]);
					if(is_array($result)){
